...
export default {
  up: async queryInterface => queryInterface.bulkInsert('Users', [{
    ...
    password: await init(),
    username: 'shegsteham',
    image: 'https://via.placeholder.com/300.png?text=Segun-In-Picture',
    ...
    username: 'Tony',
    image: 'https://via.placeholder.com/300.png?text=Chinemelu-In-Picture',
    isVerified: true,
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/300.png?text=Andrew-In-Picture',
    emailNotification: false,
    inAppNotification: false,
    isVerified: true,
    createdAt: new Date(Date.now()),
    ...
    roleId: 1,
    username: 'ahmed',
    image: 'https://via.placeholder.com/300.png?text=Ahmed-In-Picture',
    password: await init(),
    isVerified: true,
    emailNotification: true,
    inAppNotification: true,
    ...
    username: 'jide',
    image: 'https://via.placeholder.com/300.png?text=Jide-In-Picture',
    isVerified: true,
    emailNotification: true,
    inAppNotification: true,
    createdAt: new Date(Date.now()),
    ...
    username: 'nwashangai',
    image: 'https://via.placeholder.com/300.png?text=Young-In-Picture',
    isVerified: true,
    emailNotification: true,
    inAppNotification: true,
    createdAt: new Date(Date.now()),
    ...
    bio: `I am working as Senior Officer, Commercial Operation-Supply Chain,
     ...
     Laundering etc.`,
    username: 'IceCream',
    image: 'https://via.placeholder.com/300.png?text=Ademola-In-Picture',
    isVerified: true,
    emailNotification: true,
    inAppNotification: true,
    createdAt: new Date(Date.now()),
